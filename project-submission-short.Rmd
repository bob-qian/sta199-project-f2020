...
As a preliminary check to decide if further investigation is warranted, we first conducted a chi-squared test for independence. With a p-value of roughly 0, we found sufficient evidence to indicate the existence of an association between race and citation issued (See Appendix ___ for details). To investigate the nature of the association,

APPENDIX #### Exploring Race:
...
3. Randomness - Representative of traffic stops - attempted census
