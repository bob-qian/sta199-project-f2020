...
Our dataset, the "Durham" dataset in Stanford Open Policing Project, records each observation as an individual police stop recorded in Durham between December 2001 and December 2015. The "Durham" dataset has `r ncol(police)` variables and `r nrow(police)` observations.
